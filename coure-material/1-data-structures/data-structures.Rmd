...
c
```
The recycling rule: vectors of different sizes can be combined, as far as the length of the longer vector is a multiple of the shorter vectors length (otherwise a warning is issued, although the operation is carried out):
